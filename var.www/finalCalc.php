...
<script language="JavaScript">
	...
	// ACTUAL COMPUTATION	
		...
		{
		document.getElementById(PercentFeasibility).innerHTML = document.getElementById(NecessaryResultsFromPercentage).value + "% Final Exam Grade is not feasible since it is greater than 100%!";
		}
		else
		{
...
<div id = "HiddenDiv">
		...
		<form>
			<b>Current Percent: </b><input type="number" id="currentPercent" size="4" style="text-align:center;">%<br><div id=error><i>Enter the current percentage you are averaging in the course before the final exam.<br>(i.e.; Averaging 95% for the course out of 100% before the final exam)</i></div>
			<p id="PercentWarning1" size="100" style="color:red;font-size:20px;text-align:center;"> &nbsp </p>
					
			<b>Final Exam Percent: </b><input type="number" id="finalPercent" size="4" style="text-align:center;">%<br><div id=error><i>Enter the percentage value the final is of the entire total course<br>(i.e.; Final exam is worth 20% of the entire course value).</i></div>
			<p id="PercentWarning2" size="100" style="color:red;font-size:20px;text-align:center;"> &nbsp </p>

			<b>Percent Desired to Achieve in Course (after the final): </b><input type="number" id="desiredPercentFromPercentages" size="4" style="text-align:center;">%<br><div id=error><i>Enter the eventual percentage grade you want to achieve for the course following the final exam.<br>(i.e.; Want to achieve a 92% for the entire course following the final exam).</i></div>
			<p id="PercentWarning3" size="100" style="color:red;font-size:20px;text-align:center;"> &nbsp </p>

			<hr>

			<br>
			<input type="button" id="Calculate" value="Calculate!" style="font-size: 100%; height: 30px; width: 130px; font-family:arial;color:darkred; font-weight:bold; border-radius:15px/56px" 
					onclick="Calculate_Necessary_Grade_On_Final_From_Percentages('currentPercent', 'finalPercent', 'desiredPercentFromPercentages', 'PercentageNumber_tmp', 'DetermineFeasibilityPercentage', 'PercentWarning1', 'PercentWarning2', 'PercentWarning3','TypeOfPageDescription','HiddenPercentExample')">
			<br><br><br>
			...
			<br><div id=error><i>Minimum "Percentage" needed on the final exam to achieve the "Percent Desired to Achieve in Course".</i></div>
			...
			<div id = "HiddenPercentExample" style="DISPLAY: none">
					...
					<table border="0" bgcolor="#000033"	>
						 ...
						 <tr></tr><tr></tr><tr></tr>
						 <td align="left">Results: From these three parameters, you would need to receive a minimum grade of 83.58% on the final</td>
						 </tr>
						 <tr>
						 <td align="left">exam to achieve the 90% grade you desire for the course.</td>
						 </tr>
					</table>
					<font color="black">
...
<!-- START OF HIDDEN PERCENTAGE EXAMPLE SECTION-->	 
	...
	<div id = "HiddenPointsExample" style="DISPLAY: none">
		...
		<table border="0" bgcolor="#000033"	>
			 ...
			 <tr></tr><tr></tr><tr></tr>
			 <td align="left">Results: From these four parameters, you would need to receive a minimum grade of 175 on the final</td>
			 </tr>
			 <tr>
			 <td align="left">exam to achieve the 90% grade you desire for the course.</td>
			 </tr>
